...
-   [Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git "null")

-   [Docker Engine](https://docs.docker.com/engine/install/ubuntu/ "null")

-   [Docker Compose](https://docs.docker.com/compose/install/ "null")

-   [Node.js and npm](https://github.com/nodesource/distributions/blob/master/README.md "null") (LTS version recommended, e.g., v20)

-   [Python 3 and pip](https://docs.python.org/3/using/index.html "null")

-   [Python Virtual Environments (venv)](https://docs.python.org/3/library/venv.html "null")

-   `serve` (for local UI serving workaround: install globally using `bash sudo npm install -g serve` )

-   A GitHub account and a repository to host the code.

-   Accounts on [GitHub Pages](https://pages.github.com/ "null") (free, integrated with GitHub) and [Render](https://render.com/ "null") (free tier available for web services).
...
### Step 2: Setup Python Virtual Environment for API
...
### Step 3: Setup Node.js Dependencies for UI
...
### Step 5: Run the Docker Compose Stack (API, Prometheus, Grafana)
...
-   Frontend (UI): Deployed to [GitHub Pages](https://pages.github.com/ "null") for static hosting. The UI is accessible at `https://pawanxcaliber.github.io/YOUR_REPO_NAME/`. Configuration for subdirectory hosting is handled in `ui/vite.config.js` and potentially Nginx if serving with Docker in production.

-   Backend (API): Deployed as a Web Service on [Render](https://render.com/ "null") for dynamic hosting. Deployment is triggered by a GitHub Actions workflow using a secure Deploy Hook URL stored as a GitHub Secret (`RENDER_API_DEPLOY_HOOK_URL`).
